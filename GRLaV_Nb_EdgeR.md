...
Setup libraries, functions and input data
========================================================

Set required libraries and functions
...
[1] 59814     4
```
We can see that there are 59814 genes with 3 observations per gene.


Check the status of genomes and annotations I
========================================================

Some gene names are duplicated:
...
Assign unique gene names using the preexisting names, but making them unique where required by adding ".1, .2" etc.

```r
rownames(GRLaV3_vs_Nb) <- make.names(GRLaV3_vs_Nb[,1], unique=TRUE)
```

Check the status of genomes and annotations II
========================================================
Sanity check: Have the duplicated names been removed?
...
![plot of chunk unnamed-chunk-8](GRLaV_Nb_EdgeR-figure/unnamed-chunk-8-1.png)

Check the status of samples II
========================================================
...
![plot of chunk unnamed-chunk-9](GRLaV_Nb_EdgeR-figure/unnamed-chunk-9-1.png)

Check the status of samples II
========================================================

Examine a Multi-dimensional Scaling plot.
...
![plot of chunk unnamed-chunk-10](GRLaV_Nb_EdgeR-figure/unnamed-chunk-10-1.png)

Check the status of genomes and annotations
========================================================
...
![plot of chunk unnamed-chunk-12](GRLaV_Nb_EdgeR-figure/unnamed-chunk-12-1.png)
