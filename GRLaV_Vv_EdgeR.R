GRLaV3_vs_Vv <- read.delim('/workspace/hradxj/karmun_awesome_experiment/011.edgeR_Vv/GRLaV3_Vv_EdgeR.tab',header=TRUE)
# Load edgeR
library(edgeR)
...
de_genes <- DGEList(counts=GRLaV3_vs_Vv,group=replicate_relationship)
